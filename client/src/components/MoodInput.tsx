        ...
        >
          ...
          <div className="space-y-4 py-2">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground text-sm">Describe how you're feeling right now.</p>
            </div>
            ...
            <Textarea
              ...
              className="min-h-[150px] bg-white/50 border-gray-200 focus:border-primary/50 text-lg resize-none rounded-xl"
              autoFocus
            />
